                    ...
                    <div class="container">
                        <div class="">
                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="dropdown">
                                    <a href="" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true"><img src="<?php if($kry->foto_kry==''){ echo base_url('assets/users/userdefault.png');}else{ echo base_url('assets/users/'.$kry->foto_kry); } ?>" class="img-circle"></a>
